...
function refreshRentabilidad(){
  ...
  //  tableComparacion.rows[0].cells[0].innerHTML = "RENTABILIDAD "+ "<br>" + c +  " VS " +  source.toUpperCase();
   ...
   if (Math.round(tableComparacion.rows[2].cells[0].innerHTML - tableComparacion.rows[2].cells[1].innerHTML) > 0){
    ...
    tableComparacion.rows[2].cells[0].innerHTML = insertarFormatoPesos( tableComparacion.rows[2].cells[0].innerHTML);
    tableComparacion.rows[2].cells[1].innerHTML = insertarFormatoPesos( tableComparacion.rows[2].cells[1].innerHTML);
    ganancia.rows[2].cells[1].innerHTML = insertarFormatoPesos(ganancia.rows[2].cells[1].innerHTML)
...
function calcRentabilidad() {
    ...
    for (var i = 1; i < table.rows.length - 9; i++) {
      ...
      //  console.log(calc[3].innerHTML.split("$")[1]);
        ...
        table.rows[i].cells[4].innerHTML = insertarFormatoPesos(table.rows[i].cells[4].innerHTML);
    ...
    table.rows[i].cells[2].innerHTML = insertarFormatoPesos(suma);

    table.rows[i + 2].cells[1].innerHTML = insertarFormatoPesos(suma * 0.05);

    table.rows[i + 3].cells[1].innerHTML = insertarFormatoPesos(costopro);
...
function myFunction() {
 ...
 //   console.log(cal);
   ...
   // var c = alternativa;
    ...
    ingredientes.rows[i + 6].cells[1].innerHTML = insertarFormatoPesos(  ingredientes.rows[i + 6].cells[1].innerHTML);
    ingredientes.rows[i + 5].cells[1].innerHTML = insertarFormatoPesos(  ingredientes.rows[i + 5].cells[1].innerHTML);
...
function reCalcular() {
    ...
    ingredientes.rows[i + 5].cells[1].innerHTML = insertarFormatoPesos(precio * 0.08);
    var totalCostoProd = retirarFormatoPesos(ingredientes.rows[i + 3].cells[1].innerHTML);
...
function calcularRentabilidadSOF() {
   ...
   // console.log(unidadA + " " + cantidad) 
    ingredientes.rows[2].cells[4].innerHTML = Math.round(unidadA / cantidad);
    ...
    ingredientes.rows[2].cells[5].innerHTML = insertarFormatoPesos(suma);
    var costopro = Math.round(suma) + Math.round(suma * 0.05);


    //  costopro = new Intl.NumberFormat("en-US", { style: 'currency', currency: 'USD' }).format(costopro);

    ingredientes.rows[i].cells[2].innerHTML = insertarFormatoPesos(suma);

    ingredientes.rows[i + 2].cells[1].innerHTML = insertarFormatoPesos(suma * 0.05);

    ingredientes.rows[i + 3].cells[1].innerHTML = insertarFormatoPesos(costopro);
    ...
    ingredientes.rows[i + 6].cells[1].innerHTML = insertarFormatoPesos( precio - retirarFormatoPesos(ingredientes.rows[i + 5].cells[1].innerHTML) - costopro);
...
function informacionMarcas() {
    var todo = "JOHNNIE WALKER;Cerveza;2;2,8,10,5|GORDONS;Cerveza;2;2,8,10,5|SMIRNOFF;Destilado Nacional;1;4,5,6,8,10,2|BLACK & WHITE;Destilado Nacional;1;4,5,6,8,10,2|BLACK & WHITE;Cerveza;1;4,5,6,8,10,2";
    return todo;
}
function informacionServicios(){
    var info = "JOHNNIE WALKER;JOHNNIE RED & LEMON;1,2,3;- Llene el vaso con cubos de hielo <br> - Vierta 50 ml de Johnnie Walker Red Label <br>- Llene hasta el tope con gaseosa de lima <br>- Decore con una rodaja de limón <br>;Cerveza;3;2,8,10,5";
    ...
    var completo = [info,info2 , info3 , info4, info5];
    return completo;
}
